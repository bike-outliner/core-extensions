...
function CalendarPanel({ context }: { context: DOMExtensionContext<CalendarProtocol> }) {
  ...
  const monthYear = activeStartDate.toLocaleDateString('de-DE', { month: 'long', year: 'numeric' })
  ...
  return (
    ...
    >
      <Calendar
        ...
        formatShortWeekday={(_locale: any, date: Date) => date.toLocaleDateString('de-DE', { weekday: 'narrow' })}
      />
    </Disclosure>
  )
}
